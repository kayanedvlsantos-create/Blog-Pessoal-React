    ...
    async function gerarNovoTema(e: FormEvent<HTMLFormElement>) {
        ...
        if (id !== undefined) {
            ...
            try {
                ...
                ToastAlerta('Squeak! O Tema foi cadastrado com sucesso!', 'sucesso')
            } catch (error: any) {
                if (error.toString().includes('401')) {
                    handleLogout()
                    ToastAlerta("Sua sessão expirou, faça login novamente.", "info")
    ...
    return (
        <div className="container flex flex-col items-center justify-center mx-auto">
            ...
            <form className="w-1/2 flex flex-col gap-4"
                ...
                <button
                    className="rounded text-white font-bold bg-[#48474C]
                                hover:bg-pink-300 w-1/2 py-2 mx-auto flex justify-center"
                    type="submit">
